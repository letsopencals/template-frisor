					...
					>
						<div className="rounded-2xl border border-[var(--color-line)] bg-[var(--color-surface)] p-5">
							<div className="mb-5 border-b border-[var(--color-line)] pb-5">
								<p className="text-sm font-semibold text-[var(--color-cream)]">{customerName || 'My Account'}</p>
								{session?.customer?.email && (
									<p className="mt-0.5 text-xs text-[var(--color-cream-muted)]">{session.customer.email}</p>
								)}
							</div>
									...
									return (
										<Link
											...
											className={`flex items-center gap-3 px-3 py-2.5 text-sm transition-colors ${
												isActive
													? 'bg-[var(--color-surface)] font-medium text-[var(--color-cream)]'
													: 'text-[var(--color-cream-muted)] hover:bg-[var(--color-surface)]/50 hover:text-[var(--color-cream)]'
											}`}
										>
							...
							<div className="mt-5 border-t border-[var(--color-line)] pt-5">
								<button
									...
									className="flex w-full items-center gap-3 px-3 py-2.5 text-sm text-[var(--color-cream-muted)] transition-colors hover:text-red-600"
								>
