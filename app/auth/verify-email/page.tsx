			...
			>
				...
				{status === 'verifying' && (
					<div className="mt-8">
						...
						<p className="mt-4 text-sm text-[var(--color-cream-muted)]">Verifying your email...</p>
					</div>
				)}
				...
				{status === 'success' && (
					<div className="mt-8">
						...
						<h1 className="mt-6 font-display text-3xl font-semibold text-[var(--color-cream)]">Email Verified</h1>
				...
				{status === 'error' && (
					<div className="mt-8">
						...
						<h1 className="mt-6 font-display text-3xl font-semibold text-[var(--color-cream)]">Verification Failed</h1>
						<p className="mt-2 text-sm text-[var(--color-cream-muted)]">{error}</p>
						<Link
							href="/auth/sign-in"
							className="mt-6 inline-block bg-[var(--color-gold)] px-8 py-3 text-xs font-semibold uppercase tracking-[0.2em] text-white transition-all hover:bg-[var(--color-gold-bright)]"
						>
							Sign In
						</Link>
					</div>
				...
				{status === 'pending' && (
					<div className="mt-8">
						<div className="mx-auto flex h-16 w-16 items-center justify-center bg-[var(--color-gold)]/15">
						...
						<h1 className="mt-6 font-display text-3xl font-semibold text-[var(--color-cream)]">Check Your Email</h1>
						<p className="mt-2 text-sm text-[var(--color-cream-muted)]">
							We&apos;ve sent a verification link to{' '}
							{email ? <span className="font-medium text-[var(--color-cream)]">{email}</span> : 'your email'}.
							<br />
						...
						{email && (
							<button
								...
								className="mt-6 text-xs font-medium text-[var(--color-cream-muted)] underline hover:text-[var(--color-gold)] disabled:opacity-50"
							>
				...
				<p className="mt-8 text-sm text-[var(--color-cream-muted)]">
