...
export default function SettingsPage() {
	...
	return (
		<div>
			<h1 className="font-display text-3xl font-semibold text-[var(--color-cream)]">Settings</h1>
			<p className="mt-2 text-sm text-[var(--color-cream-muted)]">Manage your profile and security</p>

			<div className="mt-8 space-y-8">
				{/* Profile Section */}
				<div className="rounded-2xl border border-[var(--color-line)] bg-[var(--color-surface)] p-6">
					<h2 className="text-xs font-semibold uppercase tracking-[0.2em] text-[var(--color-cream)]">Profile</h2>
				...
				{/* Password Section */}
				<div className="rounded-2xl border border-[var(--color-line)] bg-[var(--color-surface)] p-6">
					<h2 className="text-xs font-semibold uppercase tracking-[0.2em] text-[var(--color-cream)]">Change Password</h2>
						...
						<form onSubmit={handlePasswordChange}>
							<div className="mt-6 space-y-4">
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											<FormLabel className="mb-0 text-xs font-medium normal-case tracking-normal text-[var(--color-cream-muted)]">
