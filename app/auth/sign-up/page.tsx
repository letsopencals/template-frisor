		...
		<section className="flex min-h-screen items-center justify-center bg-[var(--color-bg)] px-6 pt-20 pb-20">
			...
			>
				<div className="text-center">
					...
					<h1 className="mt-6 font-display text-3xl font-semibold text-[var(--color-cream)]">Create Account</h1>
					<p className="mt-2 text-sm text-[var(--color-cream-muted)]">Sign up to book appointments and manage your visits</p>
				</div>
					...
					<form onSubmit={form.handleSubmit(onSubmit)} className="mt-8 space-y-4">
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									<FormLabel className="mb-0 text-xs font-medium normal-case tracking-normal text-[var(--color-cream-muted)]">
										Password <span className="text-[var(--color-gold)]">*</span>
									</FormLabel>
									<FormControl>
										<input
											{...field}
